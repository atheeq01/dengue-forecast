...
Centralized configuration, directory paths, RDHS definitions,
geographic coordinates, and table schemas for the Dengue Forecast project.
"""
...
# -----------------------------------------------------------------------------
# Sri Lanka 26 Regional Directorates of Health Services (RDHS)
# Note: Sri Lanka has 25 administrative districts, but 26 health divisions
# (Ampara District is divided into Ampara and Kalmunai RDHS).
# -----------------------------------------------------------------------------
CANONICAL_RDHS = [
...
DISTRICT_COORDS: dict[str, dict[str, float]] = {
    ...
    "Ampara": {"lat": 7.2975, "lon": 81.6720},
    "Kalmunai": {"lat": 7.4167, "lon": 81.8333},
...
# -----------------------------------------------------------------------------
# Historical WER Multi-Era Table Schemas
# Keys are the total count of parsed numbers in a single division row.
# -----------------------------------------------------------------------------
TABLE_SCHEMAS: dict[int, dict[str, list[str]]] = {
    19: {  # Early reports (~2009-2012)
        "diseases": [
    ...
    20: {  # Variant with timeliness + completeness or extra indicator
        "diseases": [
            "dengue_fever", "dysentery", "encephalitis", "enteric_fever",
            "food_poisoning", "leptospirosis", "typhus", "viral_hepatitis",
            "human_rabies",
    ...
    29: {  # Mid-era reports
        ...
        "trailing_fields": ["completeness_pct"],
    },
    30: {  # Modern reports (~2019-2026)
        "diseases": [
            "dengue_fever", "dysentery", "encephalitis", "enteric_fever",
            "food_poisoning", "leptospirosis", "typhus", "viral_hepatitis",
            "human_rabies", "chickenpox", "meningitis", "leishmaniasis",
